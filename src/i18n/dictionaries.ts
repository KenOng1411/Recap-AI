...
export const dictionaries = {
  en: {
    ...
    home: {
      ...
      guidesDesc: "Honest \"is it worth it\" verdicts on individual AI tools — pricing, drawbacks, and who it's really for.",
  ...
  fr: {
    ...
    home: {
      ...
      guidesTitle: "Guides détaillés",
      guidesDesc: "Des verdicts honnêtes « ça vaut le coup ou pas » sur chaque outil IA — tarifs, inconvénients, et pour qui c'est vraiment fait.",
      guidesCta: "Voir les guides",
